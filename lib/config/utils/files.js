...
function getPackageJson() {
    var packageJson = fs_1["default"].readFileSync(path_1["default"].resolve(_1.projectPath, './package.json'));
    if (packageJson) {
        try {
...
function getCustomWebpack() {
    var jsConfigPath = path_1["default"].resolve(_1.projectPath, './webpack.custom.js');
