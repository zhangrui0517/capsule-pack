...
function getBaseConfig(extraConfig) {
    ...
    var babelPreset = (0, webpack_util_1.babelPresetGenerator)(extraConfig);
    var config = {
        entry: {
            index: path_1["default"].resolve(utils_1.rootPath, "./".concat(root, "/index"))
        },
        output: {
            filename: '[name].[contenthash:6].js',
            path: path_1["default"].resolve(utils_1.rootPath, './dist'),
            clean: true
        },
        cache: {
            type: 'filesystem',
        ...
        plugins: [
            new html_webpack_plugin_1["default"]({
                template: path_1["default"].resolve(utils_1.rootPath, "./".concat(root, "/index.html"))
            }),
