...
function packageJsonGenerator(type, callback) {
    fs_extra_1["default"].stat(path_2.packageJson, function (err, stat) {
        ...
        currentDepPackage && child_process_1["default"].execSync("npm i ".concat(currentDepPackage, " -save"));
        var currentDevPackage = packageByTemplate[type].devDependencies;
        currentDevPackage && child_process_1["default"].execSync("npm i ".concat(currentDevPackage, " -save-dev"));
